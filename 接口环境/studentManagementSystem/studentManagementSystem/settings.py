...
SECRET_KEY = 'p32(@w^dh=mhifuw=!3+53@4x66&n(a86o7zs5qyfe(3m#!x@='
...
DATABASES = {
    'default': {
        ...
        #'NAME': r'E:\Jmeter\apache-jmeter-3.1\bin\db.sqlite3',
    }
    # 'default': {
...
REST_FRAMEWORK = {
    'EXCEPTION_HANDLER': 'studentManagementSystem.utils.custom_exception_handler',
